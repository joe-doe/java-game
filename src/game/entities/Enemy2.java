...
public class Enemy2 extends Enemy {
	...
	public Enemy2(AbstractBoard board, Hero hero, int startingX, int startingY, float speedX, float speedY) {
...
//		animationHandler.movingLeftImages.add(new ImageIcon("/data/DevelopersCorner/Eclipse/JavaGame_2/images/enemy.png").getImage());
//		animationHandler.movingRightImages.add(new ImageIcon("/data/DevelopersCorner/Eclipse/JavaGame_2/images/taz_Right.png").getImage());
		...
		animationHandler.stillImages.put(SpriteArt.SPRITE_LEFT, ImageRepository.getInstance().getImage(ImageRepository.IMAGE_ENEMY2_LEFT));
		animationHandler.stillImages.put(SpriteArt.SPRITE_RIGHT,ImageRepository.getInstance().getImage(ImageRepository.IMAGE_ENEMY2_RIGHT));
